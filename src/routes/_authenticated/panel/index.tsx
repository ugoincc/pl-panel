      ...
      >
        ...
        >
          <div>
            ...
            <div
              style={{ fontSize: '0.72rem', color: C.textSec, marginTop: 3 }}
            >
              {device.model}
            </div>
          </div>
          ...
          >
            {[
              ...
              <div
                ...
                style={{ display: 'flex', flexDirection: 'column', gap: 2 }}
              >
                <span style={{ fontSize: '0.65rem', color: C.textSec }}>
                  {label}
                </span>
        ...
        >
          {drawerBtns.map(({ label, v }) => {
            const s: React.CSSProperties =
              v === 'primary'
                ? { background: C.teal, color: C.navy, border: 'none' }
                : v === 'danger'
                  ? {
                      background: 'transparent',
